...
app.route("/bookingdata").post(async function (req, res) {
    try {
        await mongoose.connect('mongodb://127.0.0.1:27017/myapp', { useNewUrlParser: true, useUnifiedTopology: true });
        ...
        const Bookdata = mongoose.model('bookingdatas', BookingSchema);

        const booking = new Bookdata({
            numberOfGuests: req.body.guest,
            checkin: req.body.checkin,
            checkout: req.body.checkout,
            guestName: 'Ankit Swarnkar',
            guestEmail: 'ankit@gmail.com',
